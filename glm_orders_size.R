...
odon_size_glm<-glm(type_part_binom~log_length, family=binomial,data=odon_occs) #odonatoptera

col_size_glm<-glm(type_part_binom~log_length, family=binomial,data=col_occs) #coleoptera

blatt_size_glm<-glm(type_part_binom~log_length, family=binomial,data=blatt_occs) #blattodea

orth_size_glm<-glm(type_part_binom~log_length, family=binomial,data=orth_occs) #orthoptera

hem_size_glm<-glm(type_part_binom~log_length, family=binomial,data=hem_occs) #hemiptera

dip_size_glm<-glm(type_part_binom~log_length, family=binomial,data=dip_occs) #diptera
...
lines(size.prd, predict.glm(odon_size_glm, data.frame(log_length=size.prd),type = "response"))
mtext("A",adj=0)
...
lines(size.prd, predict.glm(blatt_size_glm, data.frame(log_length=size.prd),type = "response"))
mtext("B",adj=0)
...
axis(2, at=c(0,1),label=F, tick=T)
lines(size.prd, predict.glm(orth_size_glm, data.frame(log_length=size.prd),type = "response"))
mtext("C",adj=0)
...
axis(2, at=c(0,1),label=c("Non-Articulated","Articulated"), tick=T)
lines(size.prd, predict.glm(hem_size_glm, data.frame(log_length=size.prd),type = "response"))
mtext("D",adj=0)
...
axis(2, at=c(0,1),label=F, tick=T)
lines(size.prd, predict.glm(dip_size_glm, data.frame(log_length=size.prd),type = "response"))
mtext("E",adj=0)
...
axis(2, at=c(0,1),label=F, tick=T)
lines(size.prd, predict.glm(col_size_glm, data.frame(log_length=size.prd),type = "response"))
mtext("F",adj=0)
